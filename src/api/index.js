...
// ------------------------------------------------------------------------
// 行业报告
export const tradeArticle = () => ajax(BASE_URL + '/Article/GetArticleShow?Keyword=&ClassifyID=32&Pagesize=150&Pageindex=1&IsRecommend=0')
// 读书报告
export const studyArticle = () => ajax(BASE_URL + '/Article/GetArticleShow?Keyword=&ClassifyID=31&Pagesize=150&Pageindex=1&IsRecommend=0')
// 零售峰会点亮行动
export const retailArticle = () => ajax(BASE_URL + '/Article/GetArticleShow?Keyword=&ClassifyID=30&Pagesize=150&Pageindex=1&IsRecommend=0')
// 线下
export const offArticle = () => ajax(BASE_URL + '/Article/GetArticleShow?Keyword=&ClassifyID=29&Pagesize=150&Pageindex=1&IsRecommend=0')
// 热点分享
export const hostArticle = () => ajax(BASE_URL + '/Article/GetArticleShow?Keyword=&ClassifyID=515&Pagesize=150&Pageindex=1&IsRecommend=0')
// 店长储备店长
